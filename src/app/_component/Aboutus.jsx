            ...
            <Wrapper>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <section>
                        ...
                        <p>Welcome to Universal, a trusted leader in the road construction machinery industry. With a passion for innovation and a commitment to excellence, we specialize in delivering top-quality machinery that empowers the construction sector to build the roads of tomorrow.Founded with a vision to revolutionize the road construction sector, Universal has grown into a leading provider of innovative machinery solutions. From humble beginnings, we’ve expanded our operations to serve clients across the globe. Our journey is driven by a passion for excellence and a commitment to supporting the construction industry with reliable, efficient, and sustainable equipment.<br />
                            At Universal, we bring decades of experience to the road construction machinery market. Our team is dedicated to understanding the unique needs of contractors, engineers, and construction companies, ensuring we provide cutting-edge solutions that enhance productivity, efficiency, and sustainability.</p>
